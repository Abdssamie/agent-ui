...
export function WorkflowGrid({ workflows, isLoading, onTriggerAction, isExecutingId }: WorkflowGridProps) {
        ...
        <div className="flex items-center justify-center py-12">
          <div className="text-center space-y-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Try adjusting your filters or create workflows in the backend.</p>
            </div>
          </div>
        </div>
      )
  ...
  }, [isLoading, rowCount, items, workflows, onTriggerAction, isExecutingId])
